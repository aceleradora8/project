...
describe Address, type: :model do
	describe 'address' do
    	before :each do
            @address = Address.new(address:"Av Ipiranga",zipcode:"90619-900",city:"Porto Alegre", state:"Rio Grande do Sul",country:"Brasil", neighborhood: "Partenon", complement: "casa", number: 123)
        ...
        it 'print address if zipcode isnt empty' do
            expect(@address.print_address).to eq("Av Ipiranga, 123, casa -\n       Partenon, Porto Alegre -\n       Rio Grande do Sul, Brasil, 90619-900")
        end
