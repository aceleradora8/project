...
describe InterestsController, type: :controller do
  describe '#create' do
    before :each do
      ...
      @volunteer = Volunteer.create!(name:"Voluntário teste",observations:"teste", phone1:"(66)6666-6666", user_id: @user.id, birth_date: '11/08/2015')
      ...
      @opportunity1 = Opportunity.create!(title: 'Opportunity1', description: "Qualquer coisa", address_id: address.id, ngo_id: @ngo.id)
